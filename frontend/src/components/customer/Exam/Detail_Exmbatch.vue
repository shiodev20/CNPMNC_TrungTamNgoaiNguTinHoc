  ...
  <div v-if="data.id && exam && exambatch" class="list_exam">
    ...
    <div v-if="this.$route.query.add == undefined" class="list_exam_child">
      ...
      <div class="list_exams">
          ...
          <div class="filter_customer">
            <label class="lb_filter_cus">
              <input
                ...
                name="klk"
              />
              <span>Đã điễm danh {{ status_ettad }}</span>
            </label>
          </div>
        </div>
        <table class="table">
          <tr>
            ...
            <th>Họ</th>
            <th>Tên</th>
            <th>Ngày sinh {{ $store.state.test.chose_type }}</th>
            <th>Trạng thái</th>
            <th v-if="status_ettad == false">Chọn</th>
            <th v-if="status_ettad == true">điểm</th>
            <th v-if="status_ettad == true">Nhập điểm</th>
          </tr>
          <tr
            :id="'item' + item.id"
          ...
          >
            ...
            <td>
              {{ item.result == null ? "Chưa điểm danh" : "Có mặt" }}
            </td>
            <td v-if="status_ettad == false" class="settings">
        ...
        <div class="atten_parent">
          <button v-if="status_ettad == false" @click="set_atten()">
            Điểm danh
          </button>
          <button v-if="status_ettad == true" @click="set_ponit()">
            Cập nhật điểm
          </button>
        </div>
      </div>
